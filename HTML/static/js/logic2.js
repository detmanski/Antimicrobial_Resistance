...
function updateChart() {
  ...
  if (dataset === "0") {
    ...
    trace1.data.datasets[0].label = "Estimated Number Data Points by Pathogen";
    trace1.update(); 
  }
  else if (dataset === "1") {
    trace1.data.datasets[0].data = dataSet2;
    trace1.data.datasets[0].label = "Estimated Number of Data Points by Antibiotic Class";
    trace1.data.labels = antibioticClass;
    trace1.update();
  }
  else if (dataset === "2") {
    trace1.data.datasets[0].data = dataSet3;
    trace1.data.datasets[0].label = "Estimated Number of Data Points by Infectious Syndrome";
